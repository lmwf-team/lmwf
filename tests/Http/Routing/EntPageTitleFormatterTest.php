...
final class EntPageTitleFormatterTest extends TestCase
{
    ...
    {
        self::assertEquals('', $this->formatter->format(new PageEntConf('', UserRepo::class), UserRepo::USER_ID));
    }

    public function testStaticStr(): void
    {
        self::assertEquals('Hello!', $this->formatter->format(new PageEntConf('Hello!', UserRepo::class), UserRepo::USER_ID));
    }
    ...
    public function testOneParam(): void
    {
        self::assertEquals(
            ...
            $this->formatter->format(new PageEntConf('Hello {{ name }}!', UserRepo::class), UserRepo::USER_ID),
        );
    }
}
